...
import com.typesafe.tools.mima.core.{ProblemFilters, MissingClassProblem, ReversedMissingMethodProblem, InheritedNewAbstractMethodProblem}
    ...
    slickGeneralSettings ++
      ...
      Seq(
        ...
        mimaBinaryIssueFilters ++= Seq(
          ...
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple19QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple5QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple12QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple22QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple8QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple4QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple15QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple18QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple11QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple7QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple21QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple3QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple14QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple17QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple10QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple13QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple6QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple20QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple2QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.relational.RelationalProfile#API.Tuple9QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple16QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple19QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple5QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple12QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple22QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple8QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple4QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple15QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple18QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple11QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple7QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple21QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple3QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple14QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple17QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple10QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple13QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple6QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple20QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple2QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.jdbc.JdbcProfile#API.Tuple9QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple16QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple19QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple5QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple12QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple22QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple8QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple4QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple15QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple18QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple11QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple7QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple21QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple3QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple14QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple17QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple10QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple13QueryExtensions"),
          ProblemFilters.exclude[InheritedNewAbstractMethodProblem]("slick.memory.MemoryProfile#API.Tuple6QueryExtensions"),
