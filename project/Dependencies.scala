...
object Dependencies {
  ...
  val logback = "ch.qos.logback" % "logback-classic" % "1.5.36"
  val hikariCP = "com.zaxxer" % "HikariCP" % "7.1.0"

  val h2 = "com.h2database" % "h2" % "2.4.240"
  val sqlServer = "com.microsoft.sqlserver" % "mssql-jdbc" % "13.4.0.jre11"
  ...
  val testDBs = Seq(
    ...
    "com.oracle.database.jdbc.debug" % "ojdbc8_g" % "21.21.0.0",
