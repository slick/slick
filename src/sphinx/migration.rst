...
:api:`MappedColumnType <scala.slick.driver.JdbcTypesComponent@MappedColumnType>`.
Its basic form (using
:api:`MappedColumnType.base <scala.slick.profile.RelationalTypesComponent$MappedColumnTypeFactory@base>`)
