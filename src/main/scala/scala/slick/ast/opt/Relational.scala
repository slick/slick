...
object Relational extends Logging {
  def apply(n: Node): Node = {
    ...
    val n5 = if(hasRowNumbers) fixRowNumberOrdering(n4) else n4
    if(n5 ne n4) logger.debug("row number ordering fixed: ", n5)
    n5
  }
  ...
  /** Rewrite zip joins into a form suitable for SQL (using inner joins and
    ...
    * which should have been generated by Columnizer.forceOuterBind. The inner
