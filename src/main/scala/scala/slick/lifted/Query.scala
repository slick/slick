...
abstract class Query[+E, U, C[_]] extends Rep[C[U]] { self =>
  ...
  private def filterHelper[T](f: E => T, wrapExpr: Node => Node)
    ...
    new WrappingQuery[E, U, C](Filter.ifRefutable(generator, toNode, wrapExpr(wt(fv).toNode)), unpackable)
  }
...
object Query extends Query[Unit, Unit, Seq] {
  ...
  def apply[E, U, R](value: E)(implicit unpack: Shape[_ <: ShapeLevel.Flat, E, U, R]): Query[R, U, Seq] = {
    ...
    if(unpackable.toNode.isInstanceOf[TableExpansion])
      new NonWrappingQuery[R, U, Seq](unpackable)
...
class NonWrappingQuery[+E, U, C[_]](val unpackable: ShapedValue[_ <: E, U]) extends Query[E, U, C] {
...
class TableQuery[E <: AbstractTable[_]](cons: Tag => E) extends NonWrappingQuery[E, E#TableElementType, Seq]({
