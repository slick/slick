...
object Operator {
  final case class Is(left: Node, right: Node) extends OperatorColumn[Boolean] with BinaryNode with BooleanColumnOps
  final case class In(left: Node, right: Node) extends OperatorColumn[Boolean] with BinaryNode with BooleanColumnOps
  final case class And(left: Node, right: Node) extends OperatorColumn[Boolean] with BinaryNode with BooleanColumnOps
  final case class Or(left: Node, right: Node) extends OperatorColumn[Boolean] with BinaryNode with BooleanColumnOps
