 ...
 */
case class ConstColumn[T](value: T)(implicit val typeMapper: TypeMapper[_,T]) extends Column[T] {
 ...
 */
case class BindColumn[T](value: T)(implicit val typeMapper: TypeMapper[_,T]) extends Column[T] {
  def nodeChildren = Nil
  override def toString = value match {
 ...
 */
case class ParameterColumn[T](idx: Int, typeMapper: TypeMapper[_,T]) extends Column[T] {
  def nodeChildren = Nil
 ...
 */
abstract class OperatorColumn[T](implicit val typeMapper: TypeMapper[_,T]) extends Column[T] {
 ...
 */
class WrappedColumn[T](parent: ColumnBase[_], val typeMapper: TypeMapper[_,T]) extends Column[T] {
 ...
 */
class NamedColumn[T](val table: Node, val name: String, val typeMapper: TypeMapper[_,T], val options: ColumnOption[T]*)
extends Column[T] {
