...
trait DistributedProfile extends MemoryQueryingProfile { driver: DistributedDriverX =>
...
trait DistributedDriverX extends MemoryQueryingDriver with DistributedProfile {
...
class DistributedDriver(val drivers: RelationalProfile*) extends DistributedDriverX { driver =>
