...
/**
 * All Exceptions that are thrown directly by Slick are of type `SlickException`. Other Exceptions originating in
 * non-Slick code are generally not wrapped but passed on directly.
 *
 * @param msg
 *   The error message
 * @param parent
