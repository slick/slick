...
import slick.ast._
import slick.compiler.{QueryCompiler, CompilerState, Phase}
import slick.jdbc.{ResultSetType, JdbcType}
...
/** Slick driver for Microsoft Access via JdbcOdbcDriver.
  ...
  *
  * <ul>
  *   <li>[[slick.profile.RelationalProfile.capabilities.columnDefaults]]:
  ...
  *   <li>[[slick.profile.RelationalProfile.capabilities.foreignKeyActions]]:
  ...
  *   <li>[[slick.profile.RelationalProfile.capabilities.likeEscape]]:
  *     Access does not allow you to specify a custom escape character for
  *     <code>like</code>.</li>
  *   <li>[[slick.profile.RelationalProfile.capabilities.pagingDrop]]:
  ...
  *   <li>[[slick.profile.RelationalProfile.capabilities.pagingPreciseTake]]:
  ...
  *   <li>[[slick.driver.JdbcProfile.capabilities.returnInsertKey]],
  *     [[slick.driver.JdbcProfile.capabilities.returnInsertOther]]:
  ...
  *     supported.</li>
  *   <li>[[slick.profile.RelationalProfile.capabilities.setByteArrayNull]]:
  ...
  *     [[slick.profile.RelationalProfile.capabilities.typeLong]]:
