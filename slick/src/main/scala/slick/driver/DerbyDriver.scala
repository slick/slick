...
/** Slick driver for Derby/JavaDB.
  ...
  *   <li>[[slick.profile.RelationalProfile.capabilities.replace]],
  *     [[slick.profile.RelationalProfile.capabilities.reverse]]:
  *     These String functions are not available in Derby.</li>
  *   <li>[[slick.profile.RelationalProfile.capabilities.pagingNested]]:
  ...
  *   <li>[[slick.profile.SqlProfile.capabilities.sequenceCycle]]:
  ...
  *   <li>[[slick.profile.RelationalProfile.capabilities.repeat]]:
