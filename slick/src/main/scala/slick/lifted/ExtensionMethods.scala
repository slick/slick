...
trait ExtensionMethods[B1, P1] extends Any {
  ...
  @inline protected[this] def tpe[T](r: Rep[T]): TypedType[T] = r
    .asInstanceOf[Rep.TypedRep[?]]
    .tpe
    .asInstanceOf[TypedType[T]]
...
trait ColumnExtensionMethods[B1, P1] extends Any with ExtensionMethods[B1, P1] {
  ...
  def in[P2, R, C[_]](e: Query[Rep[P2], ?, C])(implicit om: o#arg[B1, P2]#to[Boolean, R]) =
  ...
  def inSet[R](seq: Iterable[B1])(implicit om: o#to[Boolean, R]) =
    if (seq.isEmpty) om(LiteralColumn(false))
      ...
      om.column(Library.In, n, ProductNode(ConstArray.from(seq.map(v => LiteralNode(implicitly[TypedType[B1]], v)))))
  def inSetBind[R](seq: Iterable[B1])(implicit om: o#to[Boolean, R]) =
    if (seq.isEmpty) om(LiteralColumn(false))
      ...
      om.column(
        Library.In,
        n,
        ProductNode(ConstArray.from(seq.map(v => LiteralNode(implicitly[TypedType[B1]], v, vol = true))))
      )
...
final class BaseColumnExtensionMethods[P1](val c: Rep[P1])
    extends AnyVal
    with ColumnExtensionMethods[P1, P1]
...
final class OptionColumnExtensionMethods[B1](val c: Rep[Option[B1]])
    extends AnyVal
    with ColumnExtensionMethods[B1, Option[B1]]
    with OptionExtensionMethods[B1] {

  /**
   * Get the value inside this Option, if it is non-empty, otherwise throw a SlickException. This operation is only
   * allowed in places where it can be performed at the client side (e.g. not inside a subquery that cannot be fused),
   * otherwise the exception is thrown during query compilation.
   */
  def get: Rep[B1] =
    Rep.forNode[B1](GetOrElse(c.toNode, () => throw new SlickException("Read NULL value for column " + this)))(
      c.asInstanceOf[Rep.TypedRep[?]].tpe.asInstanceOf[OptionType].elementType.asInstanceOf[TypedType[B1]]
    )
}
...
final class BaseNumericColumnExtensionMethods[P1](val c: Rep[P1])
    extends AnyVal
    with NumericColumnExtensionMethods[P1, P1]
    with BaseExtensionMethods[P1]

final class OptionNumericColumnExtensionMethods[B1](val c: Rep[Option[B1]])
    extends AnyVal
    with NumericColumnExtensionMethods[B1, Option[B1]]
    with OptionExtensionMethods[B1]
...
final class SingleColumnQueryExtensionMethods[B1, P1, C[_]](val q: Query[Rep[P1], ?, C]) extends AnyVal {
  ...
  def countDefined(implicit ev: P1 <:< Option[?]) = Library.Count.column[Int](q.toNode)
}

/** Extension methods for Options of single- and multi-column values */
final class AnyOptionExtensionMethods[O <: Rep[?], P](val r: O) extends AnyVal {

  /** Apply `f` to the value inside this Option, if it is non-empty, otherwise return `ifEmpty`. */
  def fold[B, BP](ifEmpty: B)(f: P => B)(implicit shape: Shape[FlatShapeLevel, B, ?, BP]): BP = {
  ...
  /**
   * Return this Option if it is non-empty and applying the predicate p to this Option's value returns true. Otherwise,
   * return None.
   */
  ...
  def getOrElse[M, P2 <: P](
      default: M
  )(implicit shape: Shape[FlatShapeLevel, M, ?, P2], ol: OptionLift[P2, O]): ShapedValue.Unconst[P] = {
...
trait ExtensionMethodConversions {
  ...
  implicit def numericColumnExtensionMethods[B1](c: Rep[B1])(implicit
      tm: BaseTypedType[B1] & NumericTypedType
  ): BaseNumericColumnExtensionMethods[B1] = new BaseNumericColumnExtensionMethods[B1](c)
  implicit def numericOptionColumnExtensionMethods[B1](c: Rep[Option[B1]])(implicit
      tm: BaseTypedType[B1] & NumericTypedType
  ): OptionNumericColumnExtensionMethods[B1] = new OptionNumericColumnExtensionMethods[B1](c)
  implicit def stringColumnExtensionMethods(c: Rep[String]): StringColumnExtensionMethods[String] =
    new StringColumnExtensionMethods[String](c)
  implicit def stringOptionColumnExtensionMethods(
      c: Rep[Option[String]]
  ): StringColumnExtensionMethods[Option[String]] = new StringColumnExtensionMethods[Option[String]](c)
  implicit def booleanColumnExtensionMethods(c: Rep[Boolean]): BooleanColumnExtensionMethods[Boolean] =
    new BooleanColumnExtensionMethods[Boolean](c)
  implicit def booleanOptionColumnExtensionMethods(
      c: Rep[Option[Boolean]]
  ): BooleanColumnExtensionMethods[Option[Boolean]] = new BooleanColumnExtensionMethods[Option[Boolean]](c)

  implicit def anyColumnExtensionMethods[B1: BaseTypedType](c: Rep[B1]): AnyExtensionMethods = new AnyExtensionMethods(
    c.toNode
  )
  ...
  implicit def anyValueExtensionMethods[B1: BaseTypedType](v: B1): AnyExtensionMethods = new AnyExtensionMethods(
  ...
  implicit def anyOptionExtensionMethods[T, P](
      v: Rep[Option[T]]
  )(implicit ol: OptionLift[P, Rep[Option[T]]]): AnyOptionExtensionMethods[Rep[Option[T]], P] =
