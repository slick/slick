...
/** Common base trait for all lifted values, including columns.
  ...
  * <ul>
  *   <li>[[slick.lifted.AnyExtensionMethods]] and [[slick.lifted.ColumnExtensionMethods]] for columns of all types</li>
  *   <li>[[slick.lifted.OptionColumnExtensionMethods]] for columns of all `Option` types</li>
  ...
  *   <li>[[slick.lifted.ColumnOrdered]] for using columns in `sortBy` calls</li>
  * </ul>
  *
