...
import scala.slick.test.codegen.generated._
...
class Db1 extends {
  ...
  @Test def fkSimpleTest() {
    ...
    val Db1 = CG4
    import Db1.driver.api._
    import Db1._
    try {
      val tables = Await.result(database.run(MTable.getTables(Some(""), Some(""), None, None)), Duration.Inf)
  ...
  @Test def autoIncLastAsOptionTest() {
    val Db1 = CG9
    import slick.jdbc.StaticQuery.interpolation
    import Db1.driver.simple._
    import Db1._
    database.withSession { implicit session =>
      A.insert( ARow(1,"foo",Some("bar"),Some(2)) )
      A.insert( ARow(2,"foo",Some("bar")) )
      A.insert( ARow(3,"foo",Some("bar"),None) )
      def assertAll(all: Seq[ARow]) = {
