...
class Tables(val profile: JdbcProfile){
  ...
  class TypeTest(tag: Tag) extends Table[(
    ...
    def java_sql_Timestamp = column[java.sql.Timestamp]("java_sql_Timestamp" , O.Default("2016-06-08 19:34:34") )
    ...
    def Option_java_sql_Timestamp = column[Option[java.sql.Timestamp]]("Option_java_sql_Timestamp" , O.Default( Some("CURRENT_TIMESTAMP") ) )
