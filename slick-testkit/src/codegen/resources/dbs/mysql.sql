...
CREATE TABLE `table_name`( id INT NOT NULL, uti TINYINT UNSIGNED NOT NULL, si SMALLINT NOT NULL, mi MEDIUMINT NOT NULL, ui INT UNSIGNED NOT NULL, bi BIGINT NOT NULL/*, ubi BIGINT UNSIGNED NOT NULL*/ );
