...
/** Slick Future API for Play / Akka / Pekko applications.
  *
  * A single `import slick.future.*` activates two things:
  *
  *   1. [[slick.future.Database]] — a `Future`-based database wrapper with no type parameter,
