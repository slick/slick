...
@scaladoc[API documentation](slick.api.DatabaseConfig$#forProfileConfig[P](profile:P,path:String,config:com.typesafe.config.Config,classLoader:ClassLoader):slick.api.DatabaseConfig[profile.type])
